...
INSERT INTO `berita` VALUES (322, 'Provident impedit', 'SAT-NTB-01', 'Quas ipsum ipsam ne', 'https://www.qipalysym.org', 'Proident ducimus q', 'Quia sed minim nihil', 'Nulla natus sunt la', 'Possimus animi qui', 'Et sed ut qui repreh', '[\"MED-NTB-07|||Eiusmod incidunt ul|||Link1\",\"MED-NTB-08|||Eiusmod incidunt ul|||Link2\"]', '[\"MED-NTB-05|||Quisquam eos omnis m\"]', '2024-06-28', NULL);
...
INSERT INTO `berita` VALUES (341, 'Ut est iste dolorem', 'SAT-NTB-01', 'Alias omnis minus ve', 'https://www.pohebanega.org.au', 'Nulla reprehenderit', 'Mollit nihil ea inci', 'Minim sint atque nul', 'Rerum occaecat labor', 'Fugiat quia molesti', '[\"MED-NTB-011|||Anim incididunt ex e|||Link1\",\"MED-NTB-011|||Soluta nihil sed con|||Link2\"]', '[\"MED-NTB-10|||Rerum quasi minus co\"]', '2024-07-01', NULL);
INSERT INTO `berita` VALUES (342, 'Quibusdam dolor tene', 'SAT-NTB-01', 'Vero consequatur se', 'https://www.bonagucejajyp.us', 'Nobis dolor veritati', 'Eos saepe ab corpor', 'Dolorum labore atque', 'Dolores culpa sed e', 'Saepe vel amet sequ', '[\"MED-NTB-10|||Nam sequi saepe nece\",\"MED-NTB-02|||Optio laboriosam e\"]', '[\"no media|||Nesciunt qui enim m\"]', '2024-07-01', NULL);
