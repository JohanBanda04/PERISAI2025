...
CREATE TABLE `berita`  (
  ...
  `prioritas_id` int(255) NULL DEFAULT NULL,
  ...
  INDEX `kode_prioritas`(`prioritas_id`) USING BTREE,
  CONSTRAINT `berita_ibfk_1` FOREIGN KEY (`prioritas_id`) REFERENCES `tbl_prioritas` (`id_prioritas`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1066 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of berita
-- ----------------------------
INSERT INTO `berita` VALUES (1053, 'Berita Umum 1 Menteri', 1, 'berita_umum', 'SAT-NTB-01', 'facebookumum.com', 'websiteumum.com', 'instagramumum.com', 'twitterumum.com', 'tiktokumum.com', 'sippnumum.com', 'youtubeumum.com', '[\"MED-NTB-02|||Judul Umum Medlok 1|||Link Umum Medlok 1\",\"MED-NTB-02|||Judul Umum Medlok 2|||Link Umum Medlok 2\",\"MED-NTB-011|||Judul Nawacita|||Link Nawacita\"]', '[\"MED-NTB-017|||Judul Umum Mednas 1|||Link Umum Mednas 1\",\"MED-NTB-017|||Judul Umum Mednas 2|||Link Umum Mednas 2\"]', '2025-10-02', '2025-10-02');
INSERT INTO `berita` VALUES (1054, 'Divmin Berita 1 Menteri', 1, 'DIV-NTB-01', 'SAT-NTB-01', 'facebookdivmin.com', 'websitedivmin.com', 'instagramdivmin.com', 'twitterdivmin.com', 'tiktokdivmin.com', 'sippndivmin.com', 'youtubedivmin.com', '[\"MED-NTB-01|||Judul Medlok Divmin 1|||Link Medlok Divmin 1\"]', '[\"no media|||Judul Mednas Divmin 1|||Link Mednas Divmin 1\"]', '2025-10-02', '2025-10-02');
INSERT INTO `berita` VALUES (1055, 'Insert Berita Divyankum 1 Broo', 2, 'DIV-NTB-04', 'SAT-NTB-01', 'facebookdivyankum.com', 'websitedivyankum.com', 'instagramdivyankum.com', 'twitterdivyankum.com', 'tiktokdivyankum.com', 'sippndivyankum.com', 'youtubedivyankum.com', '[\"MED-NTB-01|||judul lokal divyankum 1|||Link Medlok Divyankum 1\",\"MED-NTB-02|||judul lokal divyankum 2|||Link Medlok Divyankum 2\"]', '[\"no media|||judul Nasional divyankum 1|||Link Mednas Divyankum 1\"]', '2025-10-07', '2025-10-07');
INSERT INTO `berita` VALUES (1056, 'Test Judul Berita Jumat MENTERI PUNYA GAWE', 1, 'berita_umum', 'SAT-NTB-01', '-', 'ntb.kemenkum.go.id', 'www.instagram.com', 'www.x.com', 'www.tiktok.com', 'www.sippn.com', '-', '[\"MED-NTB-011|||Nawacita News Menteri Gawe ||| www.nawacita.com\"]', '[\"no media|||-|||-\",\"MED-NTB-054|||JUDUL NAS Menteri Gawe |||link nya nasional\"]', '2025-10-01', '2025-10-01');
INSERT INTO `berita` VALUES (1057, 'Berita Jumat 2 ESELON 3 PUNYA GAWE', 4, 'berita_umum', 'SAT-NTB-01', 'www.facebook.com', 'ntb.kemenkum.go.id', 'www.instagram.com', 'www.x.com', 'www.tiktok.com', 'www.sippn.com', 'www.youtube.com', '[\"no media|||-|||-\",\"no media|||-|||-\"]', '[\"MED-NTB-054|||Judul Media Nasional Eselon 3 Gawe ||| www.mednas.com\",\"MED-NTB-055|||-|||-\"]', '2025-10-01', '2025-10-01');
INSERT INTO `berita` VALUES (1058, 'test giat menteri', 1, 'berita_umum', 'SAT-NTB-01', 'test giat menteri', 'test giat menteri', 'test giat menteri', 'test giat menteri', 'test giat menteri', 'test giat menteri', 'test giat menteri', '[\"MED-NTB-01|||test giat menteri|||link test giat menteri\"]', '[\"no media|||-|||-\"]', '2025-10-01', '2025-10-01');
INSERT INTO `berita` VALUES (1059, 'TEST JUMAT BERITA menteri', 1, 'berita_umum', 'SAT-NTB-01', 'LINK FACEBOOK', 'LINK WEBSITE', 'LINK INSTAGRAM', 'LINK TWITTER', 'LINK TIKTOK', 'LINK SIPPN', 'LINK YOUTUBE', '[\"MED-NTB-01|||JUDUL TRIBUN LOMBOK|||LINK TRIBUN LOMBOK\",\"MED-NTB-03|||JUDUL SUARA NTB|||LINK SUARA NTB\"]', '[\"MED-NTB-054|||JUDUL MEDIA NASIONAL 1|||LINK MEDIA NASIONAL 1\",\"MED-NTB-055|||JUDUL MEDIA NASIONAL 2|||LINK MEDIA NASIONAL 2\"]', '2025-10-01', '2025-10-01');

-- ----------------------------
-- Table structure for berita_divisi
-- ----------------------------
DROP TABLE IF EXISTS `berita_divisi`;
CREATE TABLE `berita_divisi`  (
  `id_berita` int(11) NOT NULL AUTO_INCREMENT,
  `nama_berita` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `kode_satker` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `facebook` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of berita_divisi
-- ----------------------------
INSERT INTO `berita_divisi` VALUES (1011, 'Tumbuhkan Semangat Kedisplinan dan Kekompakan Pegawai, Lapas Lombok Barat Gelar FMD', 'SAT-NTB-01', 'https://web.facebook.com/LapasIIALombokBarat/posts/pfbid0FVFBAP1gPhGoGvQCi7hZn3WnVcZcrjvr6HYt6dra6ZkANdE5ZU1uZSzVGCY4nVpUl?_rdc=1&_rdr', 'https://lapaslombokbarat.kemenkumham.go.id/berita-utama/tumbuhkan-semangat-kedisplinan-dan-kekompakan-pegawai-lapas-lombok-barat-gelar-fmd', 'https://www.instagram.com/p/C_aJyvAvOUq/', 'https://x.com/lapas_lobar/status/1830529764551221703', '-', '-', '-', '[]', '[]', '2025-10-07', '2025-10-07');
INSERT INTO `berita_divisi` VALUES (1012, 'Dukung KTT Indonesia Afrika (IAF) 2024, Menkumham Supratman Tinjau Layanan Imigrasi Di Bandara Ngurah Rai', 'SAT-NTB-01', 'https://web.facebook.com/share/p/GBr9VFjTkZvPGRXF/', 'https://lapaslombokbarat.kemenkumham.go.id/berita-utama/dukung-ktt-indonesia-afrika-iaf-2024-menkumham-supratman-tinjau-layanan-imigrasi-di-bandara-ngurah-rai', 'https://www.instagram.com/p/C_aTcp4vqsx/', 'https://x.com/lapas_lobar/status/1830549947223318726', '-', '-', '-', '[]', '[]', '2025-10-07', '2025-10-07');
INSERT INTO `berita_divisi` VALUES (1043, 'Proident id neque n', 'SAT-NTB-01', 'Commodi ea aliquip u', 'https://www.kywykul.mobi', 'Totam repellendus S', 'Voluptate sit a con', 'Dolorem dignissimos', 'Maiores iusto ea rei', 'Quis vero nobis nost', '[\"no media|||Quaerat deserunt duc|||Link1\"]', '[\"no media|||-|||-\"]', '2025-10-07', '2025-10-07');
...
CREATE TABLE `divisi`  (
  `id_divisi` int(255) NOT NULL AUTO_INCREMENT,
  `kode_divisi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- Records of divisi
-- ----------------------------
INSERT INTO `divisi` VALUES (1, 'DIV-NTB-01', 'Divisi Administrasi');
INSERT INTO `divisi` VALUES (2, 'DIV-NTB-02', 'Divisi Pemasyarakatan');
INSERT INTO `divisi` VALUES (3, 'DIV-NTB-03', 'Divisi Keimigrasian');
INSERT INTO `divisi` VALUES (4, 'DIV-NTB-04', 'Divisi Pelayanan Hukum');
...
INSERT INTO `mediapartner` VALUES (112, 'NusraNews.com', 'NusraNews', 'MED-NTB-053', 'SAT-NTB-01', 'nusranews@gmail.com', NULL, NULL, NULL, 'MED-NTB-053.png', '2024-09-04 15:45:08', NULL, '+62 813-3946-6066', 'media_lokal');
INSERT INTO `mediapartner` VALUES (113, 'Media Nasional NTB', 'MednasNTB', 'MED-NTB-054', 'SAT-NTB-01', 'mednasntb@gmail.com', NULL, NULL, NULL, 'MED-NTB-054.jpeg', '2025-07-04 10:24:59', NULL, '0987654321', 'media_nasional');
INSERT INTO `mediapartner` VALUES (114, 'Media Nasional NTB2', 'MednasNTB2', 'MED-NTB-055', 'SAT-NTB-01', 'mednasntb2@gmail.com', NULL, NULL, NULL, 'MED-NTB-055.jpeg', '2025-07-04 10:25:57', NULL, '0987612345', 'media_nasional');
...
-- Records of satker
-- ----------------------------
INSERT INTO `satker` VALUES (1, 'KANWIL NTB', 'kanwilntb', 'SAT-NTB-01', 'putriindonesiana020@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-08-23 00:00:00', '087881033420', 'humas_kanwil', NULL, NULL, 'SAT-NTB-01.jpeg');
INSERT INTO `satker` VALUES (3, 'KANWIL2 NTB', 'kaka', 'SAT-NTB-02', 'kaka@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-04-29 00:00:00', '12345678', 'humas_kanwil', NULL, NULL, 'SAT-NTB-02.png');
INSERT INTO `satker` VALUES (4, 'ADMIN SLANK', 'admin', 'SAT-NTB-03', 'admin@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-05-25 00:00:00', '12345678', 'superadmin', NULL, NULL, 'SAT-NTB-03.png');
INSERT INTO `satker` VALUES (21, 'LAPAS KELAS IIA LOBAR', 'lapaslobar', 'SAT-NTB-04', 'lapasmataram@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-07-30 00:00:00', '12345', 'humas_satker', NULL, NULL, 'SAT-NTB-04.jpeg');
INSERT INTO `satker` VALUES (22, 'LAPAS KLAS IIA SUMBAWA BESAR', NULL, 'SAT-NTB-05', 'lapassumbawa@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-04-29 00:00:00', '12345', 'humas_satker', NULL, NULL, 'SAT-NTB-05.png');
INSERT INTO `satker` VALUES (23, 'LAPAS KLAS IIB DOMPU', NULL, 'SAT-NTB-06', 'lapasdompu@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (24, 'LAPAS KLAS IIB SELONG', NULL, 'SAT-NTB-07', 'lapasselong@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (25, 'LAPAS TERBUKA KLAS IIB LOMBOK TENGAH', NULL, 'SAT-NTB-08', 'lapasterbuka@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (26, 'LPKA KLAS II LOMBOK TENGAH', NULL, 'SAT-NTB-09', 'lpka@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (27, 'LPP KLAS III MATARAM', NULL, 'SAT-NTB-010', 'lppmataram@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (28, 'RUTAN KLAS IIB PRAYA', NULL, 'SAT-NTB-011', 'rutanpraya@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-08-02 00:00:00', '12345', 'humas_satker', NULL, NULL, 'SAT-NTB-011.png');
INSERT INTO `satker` VALUES (29, 'RUTAN KLAS IIB RABA BIMA', NULL, 'SAT-NTB-012', 'rutanbima@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (30, 'BAPAS KLAS II MATARAM', NULL, 'SAT-NTB-013', 'bapasmataram@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (31, 'BAPAS KLAS II SUMBAWA BESAR', NULL, 'SAT-NTB-014', 'bapassumbawa@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (32, 'RUPBASAN KLAS I MATARAM', NULL, 'SAT-NTB-015', 'rupbasanmataram@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (33, 'RUPBASAN KLAS II SUMBAWA BESAR', NULL, 'SAT-NTB-016', 'rupbasansumbawa@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (34, 'KANIM KLAS I TPI MATARAM', NULL, 'SAT-NTB-017', 'kanimmataram@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (35, 'KANIM KLAS II TPI SUMBAWA BESAR', NULL, 'SAT-NTB-018', 'kanimsumbawa@gmail.com', '2024-01-23 15:05:54', '$2y$10$Cw8qENCNNKHvhpqAyGBY0.amMIexb0UO3L4qbzNGGAgJrijwQd.LC', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);
INSERT INTO `satker` VALUES (37, 'KANIM KLAS III NON TPI BIMA', NULL, 'SAT-NTB-019', 'kanimbima@gmail.com', '2024-01-23 15:05:54', '$2y$10$aPcRtH69SB73Hl5d5KZ3q.KsS20UCitay4A0QzG9j42vgb9dhgtmK', NULL, '2024-02-23 22:56:48', '2024-02-23 22:56:48', '12345', 'humas_satker', NULL, NULL, NULL);

-- ----------------------------
-- Table structure for tbl_prioritas
-- ----------------------------
DROP TABLE IF EXISTS `tbl_prioritas`;
CREATE TABLE `tbl_prioritas`  (
  `id_prioritas` int(255) NOT NULL AUTO_INCREMENT,
  `nama_prioritas_lengkap` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `nama_prioritas` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `created_at` datetime(0) NULL DEFAULT NULL,
  `updated_at` datetime(0) NULL DEFAULT NULL,
  `skala_prioritas` int(255) NULL DEFAULT NULL,
  PRIMARY KEY (`id_prioritas`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tbl_prioritas
-- ----------------------------
INSERT INTO `tbl_prioritas` VALUES (1, 'Menteri', 'menteri', '2025-07-16 09:54:16', '2025-07-16 09:54:16', 2);
INSERT INTO `tbl_prioritas` VALUES (2, 'Eselon 1', 'eselon1', '2025-07-16 09:54:16', '2025-07-16 09:54:16', 3);
INSERT INTO `tbl_prioritas` VALUES (3, 'Eselon 2A', 'eselon2a', '2025-07-16 09:54:16', '2025-07-16 09:54:16', 4);
INSERT INTO `tbl_prioritas` VALUES (4, 'Eselon 2B', 'eselon2b', '2025-07-16 09:54:16', '2025-07-16 09:54:16', 5);
INSERT INTO `tbl_prioritas` VALUES (5, 'Eselon 3', 'eselon3', '2025-07-16 09:54:16', '2025-07-16 09:54:16', 6);
INSERT INTO `tbl_prioritas` VALUES (6, 'Staf / JFT', 'staf', '2025-07-16 09:54:16', '2025-07-16 09:54:16', 7);
INSERT INTO `tbl_prioritas` VALUES (7, 'Presiden', 'presiden', '2025-07-16 09:54:16', '2025-07-16 09:54:16', 1);
