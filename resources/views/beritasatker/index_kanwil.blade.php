                     ...
                     stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path
                            ...
                            d="M19 11l0 2"/></svg>
                                                    ...
                                                    <select name="kode_divisi_pilihan" id="kode_divisi_pilihan"
                                                        ...
                                                        <option {{ Request('kode_divisi_pilihan')=='all_berita'?'selected':'' }} value="all_berita">
                                                            SEMUA BERITA
                                                        </option>
                                                        <option {{ Request('kode_divisi_pilihan')=='berita_umum'?'selected':'' }} value="berita_umum">
                                                            BERITA UMUM
                                                        </option>
                                                        @php
                                           ...
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap;">
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="#" class="editberita btn-sm"
                                                           ...
                                                           color: white"
                                                           id_berita="{{ $d->id_berita }}" title="Edit Berita Ini?">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <form action="{{  route('storeberita') }}" method="post" id="frmBeritaSatker" name="frmBeritaSatker"
                                ...
                                <span class="input-icon-addon">
                                  <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                                    ...
                                    <input type="text" value="" class="form-control" name="judul_berita_satker"
                                           ...
                                           placeholder="Tambah Judul Beritaa" {{--required--}}>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <div class="input_fields_wrap">
                                        <center>
                                            <label class="col-lg-12 " style="">Link Tambahan (Media Lokal)</label>
                                            <small class="lh-1" style="color: #fe1010; font-weight: bold;background-color: yellow; border-radius: 10px;">
                                ...
                                <div class="form-group">
                                    <div class="input_fields_wrap_nasional">
                                        ...
                                        <button class="add_field_button_nasional btn btn-warning m-l-15 col-lg-12 "
                                                style="margin-bottom: 15px;">
                                            Tambah Kolom Media Nasional {{--triggerjo--}}
                                        </button>
                                        <table class="m-l-15 col-lg-12">
                                            <tr class="">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <select required name="kode_media_nasional[]"
                                                                ...
                                                                <option value="">-Nama Media-</option>
                                                                <option value="no media" selected>-No Media-</option>
                                                                @foreach($getmedia as $idx=>$media)
                        ...
                        <div class="row" style="margin-bottom: 10px; margin-top: 15px;">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <center>
                                            <label class="col-lg-12 " style="font-weight: bold;">Pilih Divisi Pemilik
                                                Giat</label>
                                        </center>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <select required name="kode_divisi"
                                                                ...
                                                                <option value="">-Pilih Divisi-</option>
                                                                <option value="berita_umum" selected>-Berita Umum-
                                                                </option>
                        ...
                        <div class="row" style="margin-bottom: 10px; margin-top: 15px;">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <center><label class="col-lg-12 " style="font-weight: bold;">Pilih Urutan
                                                Prioritas</label>
                                            <small class="lh-1" style="color: #fe1010; font-weight: bold;background-color: yellow; border-radius: 10px;">
                                                <i>(*Wajib Diisi Sendiri)</i>
                                            </small>
            ...
            $(add_button_nasional).click(function (e) { //on add input button click
                ...
                if (x_nasional < max_fields_nasional) {
                    ...
                    $(wrapper_nasional).append('<div>' +
                        ...
                        '<option value="">-Nama Media-</option><option value="no media" selected>-No Media-</option>@foreach($getmedia as $idk=>$mednas) @if($mednas->jenis_media=="media_nasional") <option value="{{ $mednas->kode_media }}">{{ $mednas->name }}</option> @endif @endforeach</select></div>' +
                        '<div class="col-8"><input type="text" name="jumlah_nasional[]" id="jumlah_nasional[]" ' +
                        'class="jumlah_mednas form-control" placeholder="Judul Berita|||Link Media Nasional" value="-|||-" required ></div></div> ' +
