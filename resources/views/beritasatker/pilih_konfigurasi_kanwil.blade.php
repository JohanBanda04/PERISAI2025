            ...
            <div class="row">
                <div class="col-6">
                    <div class="input-icon mb-3">
                        ...
                        <input type="text" value="{{--{{ Request('dari_rekap') }}--}}{{ date("Y-m-d") }}" class="form-control"
                               name="dari_rekap" id="dari_rekap"
                ...
                <div class="col-6">
                    <div class="input-icon mb-3">
                        ...
                        <input type="text" value="{{--{{ Request('sampai_rekap') }}--}}{{ date("Y-m-d") }}" class="form-control"
                               name="sampai_rekap" id="sampai_rekap"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user"
                     ...
                     stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path
                        ...
                        <select name="id_konfig" id="id_konfig" class="id_konfig_satker form-control">
                            <option value="">-Pilih Konfigurasie Laporan -</option>
            ...
            <span class="input-icon-addon">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user"
                     ...
                     stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path
                        ...
                        <select name="idPrioritas" id="idPrioritas"
                                class="{{--id_konfig_satker--}} form-control">
                            <option value="">-Pilih Prioritase-</option>
                            <option value="all_priors">SEMUA</option>
                ...
                <div class="col-12">
                    <div class="form-group">
                        <input type="submit" class=" btn btn-primary w-100"
                               value="Download (.docx) Laporan Whatssap Disini">
                    </div>
                </div>
            </div>
        </form>
...
<script>
    $(function () {
        $("#dari_rekap, #sampai_rekap").datepicker({
            autoclose: true,
            todayHighlight: true,
            format: 'yyyy-mm-dd',
        });
        ...
        $('#frmGenereteWaTodayKanwil').submit(function () {
            ...
            var dari_rekap = $('#frmGenereteWaTodayKanwil').find('#dari_rekap').val();
            var sampai_rekap = $('#frmGenereteWaTodayKanwil').find('#sampai_rekap').val();
            var kode_prioritas = $('#frmGenereteWaTodayKanwil').find('#kode_prioritas').val();
            ...
            if (dari == "") {
                Swal.fire({
                    title: 'Warning!',
                    text: 'Anda Belum Memilih Tanggal Awal',
                    icon: 'warning',
                ...
                Swal.fire({
                    title: 'Warning!',
                    text: 'Anda Belum Memilih Tanggal Akhir',
                    icon: 'warning',
                    confirmButtonText: 'Ok'
                }).then((result) => {
                    $('#sampai').focus();
