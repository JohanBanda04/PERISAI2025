...
@push('myscript')
    ...
    <script>
        ...
        //console.log("realisasi_publikasi_total broyy: "+realisasi_publikasi_total);
    ...
    <script>
        ...
        //console.log("ZONA SATKER LIST BROYY:"+zona_satker_list);
        ...
        function fungsi_angka(val, key) {
            //console.log("valuenya angka broyy:" + val);
