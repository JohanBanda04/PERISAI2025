    ...
    <table class="tabelpresensi">
        ...
        $bulan = $exp_tgl_input[1];
            ...
            $bulan = substr($bulan,0,2);
                    ...
                    <td colspan="10">
                        @php
                            $get_media_name = DB::table('mediapartner')->where('kode_media',explode("|||",$link_lokal)[0])->first();
                            $explode = explode('|||',$link_lokal);
            ...
            <tr class="tdcolor">
                ...
                <td colspan="10" align="center" valign="center"
                    style="font-weight: bold; font-size: 15px; background: #eceaea">
                    @php
                        $jml_ml = 0;
                    @endphp
