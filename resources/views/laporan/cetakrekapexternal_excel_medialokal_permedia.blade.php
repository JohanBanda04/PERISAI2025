...
<head>
    <meta charset="utf-8">
    <title>Rekap Berita Media Lokal</title>
...
@php
    ...
    $kode_divisi_pilihan = isset($kode_divisi_pilihan) ? $kode_divisi_pilihan : 'all_berita';
    ...
    // Hitung jumlah berita per media langsung dari filteredBerita
    $countPerMedia = [];
...
<section class="sheet padding-10mm">
    ...
    <div style="text-align: center; margin-bottom: 15px;">
        <div id="title" class="bold" style="font-size: 18px;">
            REKAP BERITA MEDIA EKSTERNAL (LOKAL) {{ strtoupper($satker_name) }}
        </div>
    ...
    {{-- 🔹 TABEL RINGKASAN --}}
    @php
        // Ambil semua kode media yang muncul di berita
        $allMediaFromBerita = collect($filteredBerita)
            ->pluck('kode_media')
            ->unique()
            ->toArray();

        // Ambil nama media dari DB (termasuk yang tidak ada di $mediapartner)
