...
@php
    ...
    // Hitung ulang jumlah berita per media langsung dari filteredBerita
    $countPerMedia = [];
...
<section class="sheet padding-10mm">
    ...
    <table class="tabel-summary" style="width: 40%;">
        ...
        @php
            // Ambil semua kode media yang muncul di filteredBerita
            $allMediaFromBerita = collect($filteredBerita)
                ->pluck('kode_media')
                ->unique()
                ->toArray();

            // Ambil nama media dari DB, termasuk yang belum ada di $mediapartner
        ...
        @foreach($countPerMedia as $kode => $jumlah)
            @php
