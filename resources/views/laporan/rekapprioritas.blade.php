        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('cetakrekapprioritasberita') }}" id="frmLaporanBeritaPrioritas"
                                  name="frmLaporanBeritaPrioritas"
                                  target="_blank"
                                  method="post">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <select name="kode_prioritas" id="kode_prioritas"
                                                    class="form-select">
                                                <option value="">-Pilih Prioritas-</option>
                                                <option value="all_priority">SEMUA</option>

                                                @foreach($priorities->get() as $key=>$prior)
                                                    <option value="{{ $prior->id_prioritas }}">
                                                        {{ ucfirst($prior->nama_prioritas) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <button type="submit" name="exportexcelrekapexternal"
                                                    id="exportexcelrekapexternal"
...
@push('myscript')
    <script>
        $(function () {
            ...
            $('#frmLaporanBeritaPrioritas').submit(function () {
                var dari = $('#frmLaporanBeritaPrioritas').find('#dari').val();
                var sampai = $('#frmLaporanBeritaPrioritas').find('#sampai').val();

                var kode_satker = $('#frmLaporanBeritaPrioritas').find('#kode_satker').val();
                var jenis_media = $('#frmLaporanBeritaPrioritas').find('#jenis_media').val();
                var kode_divisi_pilihan = $('#frmLaporanBeritaPrioritas').find('#kode_divisi_pilihan').val();
                var kode_prioritas = $('#frmLaporanBeritaPrioritas').find('#kode_prioritas').val();
                if (dari == "") {
                    Swal.fire({
                        title: 'Warning!',
