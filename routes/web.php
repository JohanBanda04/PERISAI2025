...
Route::middleware(['auth:satker', 'checkrole'])->group(function () {
    ...
    Route::get('/beritasatker/rekapMediaByPrioritas', [DatasatkerController::class, 'rekapMediaByPrioritas'])->name('rekapMediaByPrioritas');
    ...
    Route::get('/beritasatker/laporanberitapermedia', [DatasatkerController::class, 'laporanberitapermedia'])->name('laporanberitapermedia');
    Route::post('/beritasatker/cetaklaporanberitapermedia', [DatasatkerController::class, 'cetaklaporanberitapermedia'])->name('cetaklaporanberitapermedia');
    ...
    Route::post('/beritasatker/cetakrekapprioritasberita', [DatasatkerController::class, 'cetakrekapprioritasberita'])->name('cetakrekapprioritasberita');
